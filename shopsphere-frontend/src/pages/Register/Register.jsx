    ...
    <div className='px-8 w-full lg:w-[70%]'>
      ...
      <div className='pt-4'>
        <form onSubmit={onSubmit} autoComplete='off'>
          ...
          <input type="email" name='email' value={values?.email} onChange={handleOnChange} placeholder='Email address' className='h-[48px] w-full border p-2 mt-1 mb-4 border-gray-400' required autoComplete='off'/>
          <label>Password</label>
          <input type="password" name='password' value={values?.password} onChange={handleOnChange} placeholder='Password' className='h-[48px] mt-1 w-full border p-2 border-gray-400' required autoComplete='new-password'/>
