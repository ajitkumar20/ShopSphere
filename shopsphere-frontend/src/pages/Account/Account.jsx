      ...
      {userInfo?.email &&
        <>
          ...
          <div className="md:flex mt-4">
            <ul className="flex-col space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
              <li>
                <NavLink to={"/account-details/profile"} className={({isActive})=> [isActive ? "bg-black hover:bg-gray-700":"bg-gray-700 hover:bg-black", "inline-flex items-center px-4 py-3 text-white rounded-lg active w-full"].join(" ")}>
                  <svg
              ...
              <li>
                <NavLink to={"/account-details/orders"} className={({isActive})=> [isActive ? "bg-black hover:bg-gray-700":"bg-gray-700 hover:bg-black", "inline-flex items-center px-4 py-3 text-white rounded-lg active w-full"].join(" ")}>
                  <svg
                    className="w-4 h-4 me-2 text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <NavLink to={"/account-details/settings"} className={({isActive})=> [isActive ? "bg-black hover:bg-gray-700":"bg-gray-700 hover:bg-black", "inline-flex items-center px-4 py-3 text-white rounded-lg active w-full"].join(" ")}>
                  <svg
                    className="w-4 h-4 me-2 text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
